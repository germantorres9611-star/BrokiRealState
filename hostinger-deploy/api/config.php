...
//  Edit only the DB_* constants before deploying
// ═══════════════════════════════════════════════════

define('DB_HOST', getenv('DB_HOST') ?: 'localhost');
define('DB_NAME', getenv('DB_NAME') ?: 'u123456789_broki');  // ← change
define('DB_USER', getenv('DB_USER') ?: 'u123456789_broki');  // ← change
define('DB_PASS', getenv('DB_PASS') ?: 'your_strong_password'); // ← change
...
$allowed = ['https://yourdomain.com', 'http://localhost:5173', 'http://localhost:3000'];
